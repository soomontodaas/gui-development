classdef scenario_map2_exported < matlab.apps.AppBase
...
%                 app.Image.Position=app.Image.Position+[-step(1) -step(2) 0 0];
                Red.Position=Red.Position+[-step(1) -step(2) 0 0];
                app.RDam.Position=app.RDam.Position+[-step(1) -step(2) 0 0];
                
%                 app.RDam.Position=P1+[-step(1)+10 -step(2)+10 0 0];
%                 app.DamageLabel_2.Position=P1+[-step(1)+10 -step(2)+10 0 0];
                app.DamageLabel_2.Position=app.DamageLabel_2.Position+[-step(1) -step(2) 0 0];
                app.RDam_2.Value=app.RDam.Value;
                app.BDam_2.Value=app.BDam.Value;
                pause(2);
                else
%                  app.Image.Position=app.Image.Position;
                 ...
                 app.DamageLabel_2.Position=app.DamageLabel_2.Position;
                 app.RDam_2.Value=app.RDam.Value;
                app.BDam_2.Value=app.BDam.Value;
                 app.BDam.Value=app.BDam.Value+BDam/time;
                   pause(2)
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.Image3.Position = [11 10 914 667];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = scenario_map2_exported(varargin)
